            ...
            <div>
                <Switch>
                    ...
                    <Route path="/front-end-quiz1">
                        <Quiz1 result={result} showResult={showResult} currentQuestion={currentQuestion} handleAnswerOnClick={handleAnswerOnClick}/>
                    </Route>
                    <Route path="/front-end-quiz2">
                        <Quiz2 result2={result2} showResult2={showResult2} currentQuestion2={currentQuestion2} handleAnswerOnClick2={handleAnswerOnClick2}/>
                    </Route>
                </Switch>
            </div>
        </Router>
